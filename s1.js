class ChessGame {
    ...
    initialize_board() {
        ...
        this.board[0] = [['♖', 'R', 'Black', 0], ['♘', 'N', 'Black', 0], ['♗', 'B', 'Black', 0], ['🎯', 'C', 'Black', 0], ['🏴', 'F', 'Black', 0], ['♗', 'B', 'Black', 0], ['♘', 'N', 'Black', 0], ['♖', 'R', 'Black', 0]];
        ...
        this.board[7] = [['♜', 'r', 'White', 0], ['♞', 'n', 'White', 0], ['♝', 'b', 'White', 0], ['🎯', 'c', 'White', 0], ['🏳️', 'f', 'White', 0], ['♝', 'b', 'White', 0], ['♞', 'n', 'White', 0], ['♜', 'r', 'White', 0]];
    ...
    capture_piece(base, start_row, start_col, end_row, end_col) {
        if (base.id != 'a3' && base.id != 'h3' && base.id != 'a4' && base.id != 'h4' && this.board[start_row][start_col][2] == this.board[end_row][end_col][2]) {
            if (this.board[end_row][end_col][3] == 2) {
                this.board[start_row][start_col][3] = 1
                window.alert(this.board[start_row][start_col][2] + " has handed off!")
            }
        }
        else if (base.id != 'a3' && base.id != 'h3' && base.id != 'a4' && base.id != 'h4' && this.board[start_row][start_col][2] != this.board[end_row][end_col][2]) {
            if (this.board[end_row][end_col][3] == 1) {
                this.board[start_row][start_col][3] = 2
                window.alert(this.board[start_row][start_col][2] + " has Recovered!")
            }
        }
    }
    ...
    move_piece(piece, start_row, start_col, end_row, end_col) {
        ...
        if (base.id == 'a3' && this.board[end_row][end_col][2] == "White" && this.board[start_row][start_col][3] == 2) {
            window.alert("White Wins!!")
            document.getElementById("chessboard").innerHTML = ""
            this.initialize_board();
            this.print_board();
        }
        else if (base.id == 'h3' && this.board[end_row][end_col][2] == "Black" && this.board[start_row][start_col][3] == 2) {
            window.alert("Black Wins!!")
            document.getElementById("chessboard").innerHTML = ""
            this.initialize_board();
            this.print_board();
        }
        else if (base.id == 'h3' && this.board[end_row][end_col][2] == "Black" && this.board[start_row][start_col][3] == 1) {
            ...
            this.board[start_row][start_col][3] = this.board[end_row][end_col][3] = 0
        }
        else if (base.id == 'a3' && this.board[end_row][end_col][2] == "White" && this.board[start_row][start_col][3] == 1) {
            window.alert("White Home!!")
            document.getElementById(String.fromCharCode(`${7 - end_row + 'a'.charCodeAt()}`) + `${7 - end_col}`).textContent = ' ';
            document.getElementById('a4').textContent = '🏴'
            this.board[start_row][start_col][3] = this.board[end_row][end_col][3] = 0
        }
        this.capture_piece(this.board[end_row][end_col][0], start_row, start_col, end_row, end_col);
        this.board[end_row][end_col][1] = this.board[start_row][start_col][1];
        this.board[end_row][end_col][2] = this.board[start_row][start_col][2];
        if (this.board[end_row][end_col][3] > 0)
            this.board[end_row][end_col][3] = this.board[start_row][start_col][3];
